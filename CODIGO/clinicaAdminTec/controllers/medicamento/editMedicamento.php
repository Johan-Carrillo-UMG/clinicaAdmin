<?php
	...
	$sqlUpdate = "UPDATE id17547686_db_clinicaproyecto_2021.medicamento SET nombre = '".$txt_nombre."', marca = '".$txt_marca."', descripcion = '".$txt_descripcion."', id_lote_medicina = $drop_lote, precio_costo = '".$txt_costo."', precio_venta = '".$txt_venta."' , cantidad = ".$txt_cantidad." WHERE medicamento.id_medicamento = $idEditM;";
