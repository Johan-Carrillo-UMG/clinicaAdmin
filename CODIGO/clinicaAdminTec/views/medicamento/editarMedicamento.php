...
<?php
    ...
    $db_conexionIdEdit->real_query("SELECT id_lote_medicina AS id, nombre AS nombreLote FROM id17547686_db_clinicaproyecto_2021.lotes_medicina;");
