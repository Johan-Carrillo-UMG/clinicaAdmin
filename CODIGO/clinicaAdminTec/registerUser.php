...
$db_conexionUsuarios->real_query("SELECT u.id_usuario as id, u.email, u.nombres, u.apellidos, u.password, r.rol FROM id17547686_db_clinicaproyecto_2021.usuarios AS u INNER JOIN clinicaproyecto_2021.roles AS r ON u.id_rol = r.id_rol ORDER BY u.nombres;");
