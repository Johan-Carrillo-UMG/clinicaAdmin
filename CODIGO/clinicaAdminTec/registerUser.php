...
$db_conexionUsuarios->real_query("SELECT u.id_usuario as id, u.email, u.nombres, u.apellidos, u.password, r.rol FROM dbclinicaadmin.usuarios AS u INNER JOIN clinicaproyecto_2021.roles AS r ON u.id_rol = r.id_rol ORDER BY u.nombres;");
$resultadoU = $db_conexionUsuarios->use_result();

//ROLES
$db_conexionRoles = mysqli_connect($db_host, $db_user, $db_pass, $db_nombre, $port);
$db_conexionRoles->real_query("SELECT id_rol AS id, rol FROM dbclinicaadmin.roles;");
