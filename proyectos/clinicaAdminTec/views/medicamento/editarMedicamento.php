...
$db_conexionEditM->real_query("SELECT id_medicamento AS id, nombre, marca, descripcion, precio_costo, precio_venta, cantidad FROM .medicamento Where id_medicamento= $idEdit;");
$resultadoREdit = $db_conexionEditM->use_result();
$filaMedicamentoEdit = $resultadoREdit->fetch_assoc();
?>
