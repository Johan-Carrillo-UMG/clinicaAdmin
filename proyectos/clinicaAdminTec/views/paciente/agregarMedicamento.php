...
<?php
    ...
    $db_conexionDEdit->real_query("SELECT id_empleado AS id, nombres, apellidos FROM webapsgt_dbclinicaadmin.empleados WHERE id_puesto=1;");
            ...
            <div class="col">
                ...
                <div class="row" style="margin-top: 1em;">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="txt_correo" id="txt_correo" class="form-control" value="<?php echo $filaPacienteEdit['email']; ?>" disabled>
                    </div>
                </div>
